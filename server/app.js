...
app.use(cors({
    credentials: true,
    // origin: "*"
    origin: ['http://localhost:3000', 'https://draft4u.com.pl', 'https://drafcik.skylo-test3.pl', 'https://drafcik-test.skylo-test1.pl', `${process.env.API_URL}:3000`, `${process.env.API_URL}:5000`]
}));
