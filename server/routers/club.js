...
router.get("/get-all-players", basicAuth, (request, response) => {
   const query = `SELECT id.id as identity, id.subscription, u.id as user_id, u.email, u.phone_number, u.club, u.country, u.first_name, u.salary_from, u.salary_to, u.sex, u.position, u.last_name, i.file_path, u.birthday, u.weight, u.height, u.block_range, u.attack_range, u.vertical_range 
   FROM users u 
